...
SECRET_KEY = 'django-insecure-dv+o3a6*9(bff2q*)xln2uwnv=4l-)slu19ye=*$-r%qgb)r87'
...
STATICFILES_DIRS = [
    BASE_DIR / 'tech_gadgets/static',  # Füge den Pfad zu deinem statischen Verzeichnis hinzu
]
